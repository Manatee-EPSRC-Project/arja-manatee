...
class Main {
	public static void main(String args[]) throws Exception {
			if (args[0].equalsIgnoreCase("Arja"))
				...
				KaliMain.main(args);
			else if (args[0].equalsIgnoreCase("TwoDegreeEdit"))
				TwoDegreeEditMain.main(args);
			else if (args[0].equalsIgnoreCase("OneDegreeEdit"))
				OneDegreeEditMain.main(args);
			else if (args[0].equalsIgnoreCase("GeneratePairs"))
				GeneratePairsMain.main(args);
