...
public class OneTwoEditDegreeProblem extends AbstractRepairProblem {
	/**
	 * 
	 */
	...
	private int totalUncompilable;
	public int getTotalUncompilable() {
		return totalUncompilable;
	}

	public void setTotalUncompilable(int totalUncompilable) {
		this.totalUncompilable = totalUncompilable;
	}

	public int getTotalTimeouted() {
		return totalTimeouted;
	}

	public void setTotalTimeouted(int totalTimeouted) {
		this.totalTimeouted = totalTimeouted;
	}
	...
	public void setTotalComputed(int totalComputed) {
	...
	private int totalTimeouted; 
	private int totalComputed;
	private int totalFailedTests;
	
	

	public void addUncompilable(int value) {
		totalUncompilable+=value;
	}
	
	public void addTotalFailedTests(int value) {
		totalFailedTests+=value;
		
	}
	
	public void addTotalComputed(int value) {
		totalComputed+=value;
	}
	
	public void addTotalTimeouted(int value) {
		totalTimeouted+=value;
	}
	
	public OneTwoEditDegreeProblem(Map<String, Object> parameters) throws Exception {
		super(parameters);
...
//		System.out.println("One fitness evaluation is finished...");
	...
	boolean invokeTestExecutor(Map<String, JavaFileObject> compiledClasses, Solution solution) throws Exception {
		...
		if (!testExecutor.isExceptional() && !allFailed) {
			...
			addTotalFailedTests(failureCountInPositive + failureCountInNegative);
			addTotalComputed(1);
